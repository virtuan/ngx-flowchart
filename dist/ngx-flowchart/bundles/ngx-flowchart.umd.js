(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FcEdgeDrawingService = /** @class */ (function () {
        ...
        FcEdgeDrawingService.prototype.getEdgeDAttribute = function (pt1, pt2, style, verticaledgeenabled) {
            if (verticaledgeenabled) {
                var dAddribute = "M " + (pt1.x - 50) + ", " + (pt1.y + 25) + " ";
    ...
    var FcEdgeDraggingService = /** @class */ (function () {
        function FcEdgeDraggingService(modelValidation, edgeDrawingService, modelService, model, isValidEdgeCallback, applyFunction, dragAnimation, edgeStyle, verticaledgeenabled) {
            this.edgeDragging = {
                isDragging: false,
                dragPoint1: null,
                dragPoint2: null,
    ...
    NgxFlowchartComponent.propDecorators = {
        ...
        verticaledgeenabled: [{ type: core.Input }],
